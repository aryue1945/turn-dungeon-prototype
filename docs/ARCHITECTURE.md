...
| Snapshot capture | Copy complete committed state into versioned, serializable data. No live references. Implemented: `GameSnapshot.Capture`. Not versioned yet (no schema-version field) and not wired into any turn/save/export flow. |
